# Make sure wordnet, the averaged_perceptron_tagger for the used language and punkt_tab is downloaded from nltk; e.g. use:
...
from .normalization_ext import lp_normalize
